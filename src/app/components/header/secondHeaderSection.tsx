...
export default function SecondHeaderSection() {
  return (
    ...
    <p className='text-[16px] text-white font-light'>ზედამხედველობა</p>
    <p className='text-[16px] text-white font-light'>ქართული ფული</p>
    <p className='text-[16px] text-white font-light'>საგადახდო სისტემები</p>
    <p className='text-[16px] text-white font-light'>სტატისტიკა</p>
    <p className='text-[16px] text-white font-light'>პუბლიკაციები</p> 
  </div>
