      ...
      <div className="w-[550px] h-[200px] absolute bottom-[10%] left-[4%] opacity-[0.8] bg-[#32333ECC] md:hidden">
        <div className="flex flex-col px-[12px] justify-between  gap-[20px] py-[20px]">
          ...
          <div className="flex justify-center items-center gap-[10%]">
            <button className="w-[40%] border-[1px] border-[#6D9696] rounded-[8px] h-[50px] text-[#6D9696] text-[16px] font-normal">
              გამოიწერე ბლოგი
            </button>
            <button className="w-[40%] border-[1px] border-white rounded-[8px] h-[50px] text-white text-[16px] font-normal">
